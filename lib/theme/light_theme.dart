...
ThemeData light = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF25D368))), colorScheme: const ColorScheme.light(primary: Color(0xFF25D368), secondary: Color(0xFF000000)).copyWith(error: const Color(0xFFE84D4F)),
